 ...
 * 2014-12-11	1.8.0.1     WWU         [SSWCCB-2104] Funktion BAP_BCL_GetTxPduSize, BAP_BCL_GetRxPduSize hinzugefuegt.
...
/** Konstante fuer den maximalen unsigned int 16 Bit Wert */
#define BAP_MAX_UINT16 ((uint16_t)65535)
