 ...
 * Zieldatei:       C:\workspace\sample_project\BAP_ethernet\IPv6_Multicast\FSG\FsgLarge\bap_defines.h
 *
 * BAPgen Version:  1.12.2
 * BAPgen Stand:    10.10.2023
 ******************************************************************/

#ifndef BAP_DEFINES_FSG_IPV6_H
#define BAP_DEFINES_FSG_IPV6_H
 ...
 */
#define BAP_SSW_XML (fsg.xml)

/**
 * Anzahl der Zeilen in der BAP_CanTxRomTable
 */
#define BAP_CAN_TX_ROM_TABLE_ROWS ((uint16_t)147)

/**
 * Anzahl der Zeilen in der BAP_CanRxRomTable
 */
#define BAP_CAN_RX_ROM_TABLE_ROWS ((uint16_t)147)
 ...
 */
#define BAP_INHIBIT_ROWS ((uint16_t)4)
 ...
 */
#define BAP_CAN_TX_SEGMENTATION_CHANNELS ((uint16_t)4)

/**
 * Anzahl der Zeilen in BAP_CanRxSegmentationChannels
 */
#define BAP_CAN_RX_SEGMENTATION_CHANNELS ((uint16_t)4)

/**
 * Enthaelt die Anzahl der Bytes von BAP_CanRxRingBuffer.
 */
#define BAP_CAN_RX_RING_BUFFER_SIZE ((uint32_t)502)

/**
 * Anzahl der Zeilen in der BAP_u16InterTelegramTimerTable
 */
#define BAP_INTER_TELEGRAM_TIMER_ROWS ((uint16_t)21)
...
#endif      /* #ifndef BAP_DEFINES_FSG_IPV6_H */
