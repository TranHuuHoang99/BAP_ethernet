 ...
 * Zieldatei:       C:\workspace\sample_project\POC_8255\backup\ASG\bap_defines.h
 *
 ...
 */
#define BAP_SSW_XML (BAP_SW1.12_ICC_MQBevo_V2_187_asg.xml)

/**
 * Anzahl der Zeilen in der BAP_CanTxRomTable
 */
#define BAP_CAN_TX_ROM_TABLE_ROWS ((uint16_t)88)

/**
 * Anzahl der Zeilen in der BAP_CanRxRomTable
 */
#define BAP_CAN_RX_ROM_TABLE_ROWS ((uint16_t)88)
 ...
 */
#define BAP_CAN_RX_SEGMENTATION_CHANNELS ((uint16_t)2)

/**
 * Enthaelt die Anzahl der Bytes von BAP_CanRxRingBuffer.
 */
#define BAP_CAN_RX_RING_BUFFER_SIZE ((uint32_t)282)
 ...
 */
#define BAP_FCT_ROM_TABLE_ROWS ((uint16_t)88)
