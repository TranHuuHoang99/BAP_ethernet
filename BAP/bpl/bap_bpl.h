 ...
 * 2014-03-24	1.7.1		WWU			MISAR-2004 Fix: Funktion-Like Makros fuer BAP_BPL_Start, und BAP_BPL_TaskProcessDispatcher sind entfernt.
 ...
 *
 *  @param apoLsgRomRow Zeiger auf das logische Steuergeraet.
 *
 *  @param aFctId bezeichnet die Funktion des angegebenen logischen Steuergeraetes.
 */
BAP_IMPL_FAR void
